function [out_zs,my_CSD] = make_cubic_splines_2(contact_positions,pot,Fcs,out_zs,my_E0,my_E1,my_E2,my_E3,num_out_zs)
...
%
% modified by Beatriz Herrera, March 1 2023
%
...
if nargin<8; num_out_zs = 200; end
if nargin<5 %compute E matrixes
    [my_E0,my_E1,my_E2,my_E3] = compute_Ematrixes(contact_positions);
end
