...
#define A_AMPA _p[7]
#define B_AMPA _p[8]
#define factor_AMPA _p[9]
#define DA_AMPA _p[10]
#define DB_AMPA _p[11]
#define v _p[12]
#define _g _p[13]
#define _tsav _p[14]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 AMPA C:/Users/bherr035/OneDrive - Florida International University/!!PhD_Research/Python-files/Theta_paper_sim_mpi_implementation/cell_models/EyalEtAl2018/ActiveMechanisms/AMPA.mod\n");
