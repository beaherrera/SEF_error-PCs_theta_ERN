...
#define nrn_init _nrn_init__GABAB2
#define _nrn_initial _nrn_initial__GABAB2
#define nrn_cur _nrn_cur__GABAB2
#define _nrn_current _nrn_current__GABAB2
#define nrn_jacob _nrn_jacob__GABAB2
#define nrn_state _nrn_state__GABAB2
#define _net_receive _net_receive__GABAB2 
#define bindkin bindkin__GABAB2 
...
#define Cdur Cdur_GABAB2
 double Cdur = 0.3;
#define Cmax Cmax_GABAB2
 double Cmax = 0.5;
#define Erev Erev_GABAB2
 double Erev = -95;
#define KD KD_GABAB2
 double KD = 100;
#define K4 K4_GABAB2
...
#define K1 K1_GABAB2
 double K1 = 0.52;
#define cutoff cutoff_GABAB2
 double cutoff = 1e+12;
#define n n_GABAB2
 double n = 4;
#define warn warn_GABAB2
 double warn = 0;
 ...
 "Cmax_GABAB2", &Cmax_GABAB2,
 "Cdur_GABAB2", &Cdur_GABAB2,
 "K1_GABAB2", &K1_GABAB2,
 "K2_GABAB2", &K2_GABAB2,
 "K3_GABAB2", &K3_GABAB2,
 "K4_GABAB2", &K4_GABAB2,
 "KD_GABAB2", &KD_GABAB2,
 "n_GABAB2", &n_GABAB2,
 "Erev_GABAB2", &Erev_GABAB2,
 "warn_GABAB2", &warn_GABAB2,
 "cutoff_GABAB2", &cutoff_GABAB2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 GABAB2 C:/Users/bherr035/OneDrive - Florida International University/!!PhD_Research/Python-files/Theta_paper_sim_mpi_implementation/cell_models/EyalEtAl2018/ActiveMechanisms/gaba_b.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 168 in file gaba_b.mod:\n	SOLVE bindkin METHOD derivimplicit\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 3; ++_i) {
